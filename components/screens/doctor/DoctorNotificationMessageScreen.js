...
//import { getUsers } from "../../../utility/firebase/crudOperations";
import { USER_TYPE } from "../../consts/data";


export default function DoctorNotificationMessageScreen({ navigation }) {
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <TouchableOpacity
                  ...
                  activeOpacity={1}
                  onPress={() => navigation.navigate("DoctorNotificationMessageDetailsScreen", item)}
                >
                  <NotificationMessageSection message={item} index={index} />
                </TouchableOpacity>
              )}
            />
          </View>
